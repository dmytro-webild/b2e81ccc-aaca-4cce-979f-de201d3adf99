...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "See Example Websites",          href: "#portfolio"},
        {
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        ...
        {
          id: "4",          name: "Exterior Paint Hub",          price: "Premium Design",          variant: "Service Site",          imageSrc: "http://img.b2bpic.net/free-photo/3d-graph-computer-illustration_23-2151884890.jpg"},
        {
  ...
  <div id="process" data-section="process">
      ...
      features={[
        {
          title: "Strategy & Planning",          description: "We identify your local market goals.",          icon: Target,
          mediaItems: [
            {
        ...
        {
          title: "Design & Development",          description: "Building a custom, conversion-first site.",          icon: Layout,
          mediaItems: [
            {
        ...
        {
          title: "Launch & Optimize",          description: "Deploying for maximum lead generation.",          icon: Rocket,
          mediaItems: [
            {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "4",          title: "Best in Class",          quote: "Professional, clean, and fast design.",          name: "David Kim",          role: "Director",          imageSrc: "http://img.b2bpic.net/free-photo/front-view-cute-girl-looking-away_23-2148436134.jpg"},
        {
          id: "5",          title: "Highly Recommend",          quote: "Perfect for local service providers.",          name: "Jessica Lee",          role: "Owner",          imageSrc: "http://img.b2bpic.net/free-photo/smiling-middle-aged-attractive-woman-showing-thumb-up-outdoors_1262-12526.jpg"},
      ]}
  ...
  <div id="social" data-section="social">
      ...
      useInvertedBackground={false}
      names={[
        "Microsoft",        "Google",        "Apple",        "Amazon",        "Tesla",        "Adobe",        "Meta"]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "How long does it take?",          content: "Typically 2-4 weeks for a full site."},
        {
          id: "q2",          title: "Do you offer maintenance?",          content: "Yes, we provide ongoing updates and support."},
        {
          id: "q3",          title: "What industries do you work with?",          content: "Primarily local service-based businesses."},
      ]}
