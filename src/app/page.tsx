...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      description="Decka Agency builds modern, credibility-focused websites designed specifically for local service businesses. We showcase real example websites and measurable results to help you understand the impact before you commit."
      buttons={[
        {
          text: "See Example Websites",
          href: "#portfolio",
        },
        {
          text: "How It Works",
      ...
      carouselItems={[
        ...
        },
        {
          ...
          imageAlt: "Website Portfolio 4",
        },
        {
          id: "5",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-mechanic-with-tablet_23-2148480379.jpg",
          imageAlt: "Website Portfolio 5",
        },
        {
          id: "6",
          imageSrc: "http://img.b2bpic.net/free-photo/long-shot-man-with-helmet-sitting-roof_23-2149343711.jpg",
          imageAlt: "Website Portfolio 6",
        },
      ]}
    />
  </div>
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        {
          id: "1",
          name: "Cleaning Co Landing",
          price: "High Conversion",
          variant: "Service Site",
          imageSrc: "http://img.b2bpic.net/free-photo/ecology-fresh-lush-natural-nature_53876-133745.jpg",
        },
        {
          id: "2",
          name: "Landscape Pros Site",
          price: "Growth Oriented",
          variant: "Service Site",
          imageSrc: "http://img.b2bpic.net/free-photo/go-green-responsibility-sustainable-concept_53876-13915.jpg",
        },
        {
          id: "3",
          name: "Pressure Wash Results",
          price: "Lead Focused",
          variant: "Service Site",
          imageSrc: "http://img.b2bpic.net/free-photo/construction-building-architecture-concept_53876-120128.jpg",
        },
        {
          id: "4",
          name: "Exterior Paint Hub",
          price: "Premium Design",
          variant: "Service Site",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-graph-computer-illustration_23-2151884890.jpg",
        },
        {
          id: "5",
          name: "Plumbing Solutions Site",
          price: "UX Focused",
          variant: "Service Site",
        ...
        {
          id: "6",
          name: "Roofing Pro Portfolio",
          price: "Credibility Driven",
          variant: "Service Site",
          imageSrc: "http://img.b2bpic.net/free-vector/gradient-abstract-technology-landing-page-template_23-2149088825.jpg",
        },
      ]}
      ...
      metrics={[
        {
          ...
          value: "45%",
          title: "Lead Increase",
          description: "Average conversion growth.",
        ...
        },
        {
          ...
          description: "Boosted marketing efficiency.",
        ...
        },
        {
          ...
          value: "2.5s",
          title: "Load Speed",
          description: "Faster than industry standards.",
      ...
      features={[
        {
          ...
          description: "We identify your local market goals.",
          icon: Target,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Building a custom, conversion-first site.",
          icon: Layout,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Deploying for maximum lead generation.",
          icon: Rocket,
          mediaItems: [
            {
              imageSrc: "http://img.b2bpic.net/free-vector/modern-web-banners-with-flat-design_23-2147937081.jpg",
            },
            {
      ...
      testimonials={[
        {
          ...
          quote: "Decka Agency built our new site in record time.",
          name: "Sarah Johnson",
          role: "Owner",
        ...
        },
        {
          ...
          quote: "We saw a 30% increase in calls within the first month.",
          name: "Michael Chen",
          role: "Manager",
        ...
        },
        {
          ...
          quote: "Zero back-and-forth. Very efficient design.",
        ...
        },
        {
          id: "4",
          title: "Best in Class",
          quote: "Professional, clean, and fast design.",
          name: "David Kim",
          role: "Director",
        ...
        },
        {
          ...
          quote: "Perfect for local service providers.",
          name: "Jessica Lee",
          role: "Owner",
  ...
  <div id="social" data-section="social">
      ...
      description="Proudly working with industry-leading platforms."
    />
  </div>
      ...
      faqs={[
        {
          ...
          content: "Typically 2-4 weeks for a full site.",
        },
        {
          id: "q2",
          title: "Do you offer maintenance?",
          content: "Yes, we provide ongoing updates and support.",
        },
        {
          id: "q3",
          title: "What industries do you work with?",
          content: "Primarily local service-based businesses.",
        },
      ]}
